...
{
ArithmeticExceptionHour(String s)
{
super(s);
}
}
...
{
ArithmeticExceptionMinute(String s)
{
super(s);
}
}
...
{
ArithmeticExceptionSeconds(String s)
{
super(s);
}
}
...
/*throws ArithmeticExceptionMinutes
throws ArithmeticExceptionSeconds
